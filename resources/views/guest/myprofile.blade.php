...
<div class="container">
  <div class="row mt-5">
    <div class="col-md-3 offset-md-1">
      ...
      <span class="text-secondary" id="re">candrasptr </span><br>
      <span class="text-secondary" id="re">VII A </span><br><hr>
        ...
        <div class="card-body">
            <form method="post" action="">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="nama" class="form-control form-control-md" value="Candra Saputra" id="colFormLabelSm" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="username" class="form-control form-control-md" id="colFormLabelSm" value="candrasptr" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="kelas" class="form-control form-control-md" id="colFormLabelSm" value="VII A" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  <input type="text" name="kelas" class="form-control form-control-md" id="colFormLabelSm" value="csaputra2412@gmail.com" required>
                </div>
              </div>
